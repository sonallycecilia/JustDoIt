...
class NotificationControllerTest {
    ...
    @Test
    void deleteAllNotifications_unauthenticated_returnsUnauthorized() throws Exception {
        mockMvc.perform(delete("/notifications").with(csrf()))
                .andExpect(status().isUnauthorized());

        verify(notificationService, never()).deleteAllNotifications(any());
    }
